...
namespace jcdatabase.Migrations
{
    ...
    [Migration("20260209103924_RefineResponseStatistics")]
    partial class RefineResponseStatistics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("jcdatabase.Models.JokeUserResponse", b =>
                {
                    b.Property<int>("JokeId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("JokeId", "UserId", "CreatedAt");

                    b.HasIndex("UserId");

                    b.HasIndex("JokeId", "CreatedAt");

                    b.ToTable("JokeUserResponses", null, t =>
                        {
                            t.HasCheckConstraint("CK_EmotionValue", "[Emotion] IN ('sleepy','none','happy','lol','lshic')")
                                .HasName("CK_EmotionValue1");
                        });
                });
            ...
            modelBuilder.Entity("jcdatabase.Models.ResponseStatistic", b =>
                {
                    ...
                    b.Property<DateOnly>("ResponseDay")
                        .HasColumnType("date");

                    b.Property<int>("Counter")
                        .HasColumnType("int");

                    b.HasKey("JokeId", "ResponseDay");
            ...
            modelBuilder.Entity("jcdatabase.Models.JokeUserResponse", b =>
                {
                    ...
                    b.HasOne("jcdatabase.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
